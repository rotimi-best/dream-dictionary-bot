...
class DictionaryController extends TelegramBaseController
{
    ...
    spellCheckerLogic($, word, user, userId) {
        ...
        if(correct){
            ...
            $.sendMessage(`Hey ${user}, your spelling is correct ${emojis.smile}, go ahead and find the meaning of the word\n\n1. Open the *MENU* (_The ICON on the top-right of your keyboard_),\n2. Click Search \n3. Enter the word: *${word}*`, {parse_mode: 'Markdown'})
    ...
    _serializeList(user, word, suggestions, func) {
        ...
        serialized +=  `\nTo find the meaning of any of the word:\n1. Opening the *MENU* (_The ICON on the top-right of your keyboard_),\n2. Click Search \n3. Enter any of the above suggestions: *${suggestions[suggestions.length - 1].charAt(0).toUpperCase() + suggestions[suggestions.length - 1].slice(1)}*`
        return serialized;
    }
}
